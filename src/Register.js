...
{   const [type, updatetype] = useState("password"); 
    ...
    return <div class="register">
        <div class="container-fluid">
                ...
                <div class="offset-4 col-4">
                    <form onSubmit={
                     async (e)=>{
                        ...
                        let res = await UserRegister(obj);
                        updateemail("");
                        updateimg(imgdata);
                        updatename("");
                        updatepass("");
                   ...
                   <img src={img} class="regprofilepic"/><br/><br/>
          ...
          <div class="mb-3">
           ...
           <input type="text" class="form-control" id="exampleFormControlInput1" required value={profilename} onChange={
             (e)=>{
          ...
          <input type={type} class="form-control" id="exampleFormControlInput1" placeholder="" required minLength="8" value={cpass} onChange={
             (e)=>{
  ...
  <label class="form-check-label" for="flexCheckDefault">
    Show password
         ...
         <div class="mb-3">
           {message==="Registered"?<span style={{color:"green"}}>{message}</span>:<span style={{color:"red"}}>{message}</span>}
         </div>
         <div class="mb-3">
